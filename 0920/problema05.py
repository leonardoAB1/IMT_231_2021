"""
Problema 5
En un Vector típico el tamaño del array interno disminuye luego de 
que un número suficiente de elementos hayan sido removidos. 
Implemente una estrategia para disminuir el tamaño del array a medida que los elementos son removidos. 
Modifique su implementación de la anterior pregunta para incluir esta estrategia.
"""
...
class Vector():
    ...
    3
    >>> print(f"{A}, elements:{A._elements}, capacity:{A._capacity}")
    [4,7,101,5,6,7,8,None], elements:7, capacity:8
    >>> C=A.subVector(2,5)
    ...
    def _realloc(self, newCapacity):
        ...
        if newCapacity<self._elements:
            self._elements=newCapacity
    ...
    def remove(self, index):
        ...
        index debe estar dentro del rango válido
        Al remover los items necesarios para que la capacidad sea del
        doble de la necesaria, la capacidad del vector se reduce
        -> el tamaño se reduce.
        """
        assert index<self._elements, "Index out of range"
        ...
        if 2*self._elements==self._capacity:
